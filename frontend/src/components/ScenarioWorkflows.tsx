            ...
            <div className="space-y-1.5">
              {sc.steps.map((step, idx) => (
                <button
                  ...
                  className="w-full flex items-center gap-2.5 p-2 rounded-lg hover:bg-blue-50 transition-colors group text-left"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="text-sm font-medium text-gray-700 group-hover:text-blue-600 transition-colors block truncate">
                      {step.name}
                    </span>
                  ...
                  <svg
                    className="w-3.5 h-3.5 text-gray-300 group-hover:text-blue-400 transition-colors shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
