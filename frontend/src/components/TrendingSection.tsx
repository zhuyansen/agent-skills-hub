  ...
  return (
    <section className="mb-10">
        ...
        <div className="flex items-center justify-center gap-3 mb-4">
          <button
            ...
            className={`p-1.5 rounded-lg transition-colors ${
              canPrev ? "hover:bg-gray-100 text-gray-600" : "text-gray-300 cursor-not-allowed"
            }`}
          ...
          <button
            ...
            disabled={!canNext}
            className={`p-1.5 rounded-lg transition-colors ${
              canNext ? "hover:bg-gray-100 text-gray-600" : "text-gray-300 cursor-not-allowed"
            }`}
      ...
      {tab === "history" && !historyLoading && weeks.length === 0 && (
        <div className="text-center py-8 text-gray-400 text-sm">{t("trending.noHistory")}</div>
      )}
          ...
          {historyItems.map((entry) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                />
                <div className="min-w-0 flex-1">
                  <span className="text-xs text-gray-500 truncate block">{entry.author_name}</span>
