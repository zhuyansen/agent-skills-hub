...
const STEPS = [
  {
    ...
    titleZh: "自动采集",
    descEn:
      "Our crawler continuously scans GitHub for new AI agent tools, MCP servers, and Claude skills across 186,000+ repositories.",
    descZh:
      "爬虫持续扫描 GitHub 上 186,000+ 仓库中的新 AI Agent 工具、MCP 服务器和 Claude 技能。",
  },
  {
    num: "02",
    icon: "⚡",
