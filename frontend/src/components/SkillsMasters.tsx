...
import { fetchMasters, type Master } from "../api/client";
...
export function SkillsMasters() {
  ...
  return (
    <section className="mb-10">
      ...
      {/* Curated masters - featured cards */}
          ...
          >
            ...
            {m.tags.length > 0 && (
              <div className="flex flex-wrap gap-1 mb-3">
                {m.tags.map((t) => (
                  <span key={t} className="px-2 py-0.5 text-[10px] rounded-full bg-indigo-50 text-indigo-500 border border-indigo-100">
                    {t}
                  </span>
                ))}
              </div>
              ...
              return (
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-500">
                        ...
                        <span className="flex items-center gap-0.5">
                          ...
                          {m.total_stars >= 1000 ? `${(m.total_stars / 1000).toFixed(1)}k` : m.total_stars}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    {m.top_repos.slice(0, isExpanded ? 5 : 2).map((r) => (
                      <a
                        key={r.id}
                        href={r.repo_url}
                        target="_blank"
