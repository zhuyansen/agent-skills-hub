        ...
        <>
          <div className="mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">{t("masters.title")}</h2>
              <span className="text-sm text-gray-400 dark:text-gray-500">{t("masters.subtitle")}</span>
            </div>
              ...
              >
                ...
                <div className="space-y-1.5">
                  {m.top_repos.slice(0, 4).map((r) => (
                    ...
                    >
                      <span className="font-medium text-gray-800 dark:text-gray-200 truncate flex-1">{r.repo_name}</span>
      ...
      {orgs.length > 0 && (
        <>
          <div className="flex items-center gap-2 mb-3 mt-6">
            ...
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200">{t("emerging.title")}</h3>
            <span className="text-xs text-gray-400 dark:text-gray-500">{t("emerging.subtitle")}</span>
          </div>
                ...
                >
                  ...
                  <div className="space-y-1">
                    {visibleRepos.slice(0, isExpanded ? 5 : 2).map((r) => (
                      ...
                      >
                        <span className="font-medium text-gray-700 dark:text-gray-200 truncate">{r.repo_name}</span>
