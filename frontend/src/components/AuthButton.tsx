        ...
        <div className="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-xl shadow-xl p-5 z-50">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full px-4 py-2.5 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {submitting && (
            ...
            {mode === "signin" && (
              <>
                <button
                  ...
                  className="block w-full text-xs text-gray-400 hover:text-blue-500 transition-colors"
                >
                  Forgot password?
                </button>
                <button
                  onClick={() => switchMode("signup")}
                  className="block w-full text-xs text-blue-500 hover:text-blue-700 transition-colors"
                >
