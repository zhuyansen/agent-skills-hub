export const translations = {
  zh: {
    ...
    "audit.cta": "免费检查",
    "audit.hint":
      "免费 · 无需注册 · 已覆盖 186,000+ 个 AI agent skill 与 MCP server",
    ...
    "faq.a1":
      "AgentSkillsHub 是开源 AI Agent 工具的安全评级目录，收录 186,000+ 个 Agent Skills、MCP 服务器和自动化工具，安全评级 + 质量评分 + 每 8 小时自动更新。",
    "faq.q2": "质量评分是如何计算的？",
    "faq.a2":
  ...
  en: {
    ...
    "detail.auditRepo": "🔍 Audit this repo",
    ...
    "audit.hint":
      "Free · No signup · Covers 186,000+ AI agent skills & MCP servers",
