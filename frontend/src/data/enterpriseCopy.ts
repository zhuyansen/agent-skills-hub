...
export const EN: EnterpriseCopy = {
  ...
  form: {
    h2: "Get your free MCP security audit",
    sub: "Tell us what you're running. We'll email you a graded security audit — the top risks in your MCP/agent stack — within 48h. No call, no slides.",
    okTitle: "Thanks — your audit is on its way.",
    okBody:
      "We'll email your security audit within 48h. If urgent, ping @GoSailGlobal on X.",
    fields: {
      full_name: "Full name",
      email: "Work email *",
      company: "Company",
      ...
      useCase: "What should we audit? *",
      useCasePlaceholder:
        "Paste a GitHub repo, list your MCP servers, or describe your agent stack.",
    ...
    privacy:
      "We'll never share your data. Submissions are stored encrypted. Manual review by Jason within 48h.",
    errMissing: "Please add your work email and what you'd like audited.",
...
export const ZH: EnterpriseCopy = {
  ...
  form: {
    h2: "免费领取你的 MCP 安全审计",
    sub: "告诉我们你在跑什么,我们会在 48 小时内把一份评级过的安全审计发到你邮箱 —— 你 MCP/agent 技术栈里最要紧的风险。无需通话,没有 PPT。",
    okTitle: "收到 —— 审计报告马上发你。",
    okBody:
      "我们会在 48 小时内把安全审计发到你邮箱。急的话可以在 X 上 @GoSailGlobal。",
    fields: {
      full_name: "姓名",
      email: "工作邮箱 *",
      company: "公司",
      ...
      useCase: "要审计什么? *",
      useCasePlaceholder: "贴一个 GitHub 仓库、列出你的 MCP server,或描述你的 agent 技术栈。",
    ...
    submitting: "提交中…",
    privacy:
      "我们绝不分享你的数据。提交内容加密存储。Jason 会在 48 小时内人工审阅。",
    errMissing: "请填写工作邮箱和想审计的内容。",
    errGeneric: "提交失败。",
  },
};
