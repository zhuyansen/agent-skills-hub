...
function buildIndexHtml(scenarios, scenarioSkillCounts, assetTags) {
  ...
  const groups = [
    ...
    { label: "Data & Search", zh: "数据与搜索", icon: "📊", slugs: ["web-scraping", "semantic-search", "vector-database", "data-pipeline", "document-parsing", "data-visualization", "knowledge-base", "obsidian-second-brain", "database-migration"] },
    { label: "Content & Writing", zh: "内容创作", icon: "✍️", slugs: ["content-writing", "ppt-presentation", "image-generation", "video-editing", "translation", "summarization", "text-to-speech"] },
